...
Global : 
   ...
   * création des entity (avec des contraintes de validation) et form correspondant
   ...
   * réalisation de fixture pour peupler la BDD
...
Employee:
   ...
   * possibilité d'ajout d'un employée en le liant a une entity métier grace un formulaire
   * possibilité de modifier un employe a l'aide d'un formaulre prerempli
